...
# WARNING: Ensure imports from `cuddly_octo_palm_tree` comes after this line
from cuddly_octo_palm_tree import app, settings, db  # noqa
from cuddly_octo_palm_tree.cli import create_user, cli  # noqa
